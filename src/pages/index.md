  ...
  - type: grid_section
    ...
    grid_items:
      ...
      - title: Secure Data Syndication
        ...
        title_align: left
        content: >
          Above gives you and intermediate layer to transfer, replicate and
          reshape data sets for other parties, providing them an unique API key
          with fine-grained security control
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
