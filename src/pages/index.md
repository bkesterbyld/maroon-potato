...
sections:
  - type: hero_section
    ...
    content: >-
      ...
      without having to learn anything. Take advantage of Above's edge, parallel
      and in-memory computing features to speed up user interactions, handle
      massive data or comply with privacy laws.
    actions:
      - label: Join the Beta
